...
class SettingsAdvertiserScreen extends StatefulWidget {
  const SettingsAdvertiserScreen({super.key});

  @override
  State<SettingsAdvertiserScreen> createState() => _SettingsAdvertiserScreenState();
}

class _SettingsAdvertiserScreenState extends State<SettingsAdvertiserScreen> {
              ...
              child: Column(
                children: [
                  ...
                  TUserProfileTile(
                    ...
                    emailUser: shopName,
                    onPressed: () {
                    Get.to(() => const ProfileAdvertiserScreen());
                  }
                  ),
