...
class SignUpToAdvertiserForm extends StatefulWidget {
  const SignUpToAdvertiserForm({super.key});

  @override
  // ignore: library_private_types_in_public_api
  _SignUpToAdvertiserFormState createState() => _SignUpToAdvertiserFormState();
}

class _SignUpToAdvertiserFormState extends State<SignUpToAdvertiserForm> {
  final _formKey = GlobalKey<FormState>();
  final _shopNameController = TextEditingController();
  final _lastNameAdvertiserController = TextEditingController(); // clé du formulaire
  final _firstNameAdvertiserController = TextEditingController(); // clé du formulaire
        ...
        child: Column(
          children: [
              ...
              child: TextFormField(
                ...
                validator: (value) {
                  if (value == null || value.isEmpty) {
                    return "Veuillez entrez le nom de votre établissement";
                  }
                  return null;
                },
              ),
            ...
            DelayedAnimationClassName(
              delay: 1000,
              child: TextFormField(
                controller: _lastNameAdvertiserController,
                style: GoogleFonts.poppins(color: TColors.primary),
                obscureText: false,
                decoration: InputDecoration(
                  focusColor: TColors.primary,
                  labelStyle: GoogleFonts.poppins(color: TColors.black),
                  labelText: TTexts.advertiserLastName,
                ),
                validator: (value) {
                  if (value == null || value.isEmpty) {
            ...
            DelayedAnimationClassName(
              delay: 1000,
              child: TextFormField(
                controller: _firstNameAdvertiserController,
                style: GoogleFonts.poppins(color: TColors.primary),
                obscureText: false,
                decoration: InputDecoration(
                  labelStyle: TextStyle(color: TColors.black),
                  labelText: TTexts.advertiserFirstName,
                ),
                validator: (value) {
                  if (value == null || value.isEmpty) {
                    return "Veuillez entrez votre nom";
